...
void print_mpd(yajl_gen json_gen, char* buffer, const char* format, const char* format_off, char *status_play, char *status_pause, char *status_stop, const char* host, int port, const char* password);
